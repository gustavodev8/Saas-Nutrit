...
const QuickAction = ({ icon: Icon, label, description, to, compact = false }: QuickActionProps) => {
  ...
  if (compact) {
    return (
      <button
        type="button"
        onClick={() => navigate(to)}
        className="group rounded-2xl border border-border/80 bg-card p-4 text-left shadow-sm transition hover:-translate-y-0.5 hover:border-primary/30 hover:shadow-md"
      >
        <div className="flex items-start justify-between gap-3">
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div className="max-w-2xl">
            ...
            <h1 className="mt-2 text-2xl font-semibold tracking-tight text-foreground lg:text-3xl">
              Painel de rotina clinica
            </h1>
            <p className="mt-2 text-sm leading-6 text-muted-foreground">
              Visao rapida de agenda, pacientes e pendencias para operar o atendimento sem
              precisar cacar informacoes em varias telas.
            </p>
          </div>
        ...
        <>
          <section className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
            ...
            <SummaryCard
              ...
              hint="pendencias financeiras ativas"
            ...
            <SummaryCard
              ...
              hint="sessoes finalizadas neste mes"
              tone="blue"
            />
            <SummaryCard
              icon={Users}
          ...
          <section className="grid gap-5 xl:grid-cols-[minmax(0,1.08fr)_minmax(320px,0.92fr)] xl:items-start">
            <div className="space-y-5">
              <div className="rounded-3xl border border-border/80 bg-card p-4 shadow-sm lg:p-5">
                <div className="mb-4 flex items-center justify-between gap-3">
                  <div>
                    <h2 className="text-base font-semibold text-foreground">Proximos atendimentos</h2>
                ...
                {dashboard.nextBookings.length === 0 ? (
                  <div className="rounded-2xl border border-dashed border-border/80 bg-muted/15 px-6 py-8 text-center">
                    ...
                    <p className="mx-auto mt-2 max-w-sm text-sm leading-relaxed text-muted-foreground">
                      Crie uma consulta inicial ou retorno para manter a rotina clinica em
                      movimento.
                    </p>
                    <Button
                      variant="outline"
                      ...
                      >
                        ...
                        <span className="min-w-0 flex-1">
                          ...
                          <span className="block text-xs text-muted-foreground">
                            {formatShortDate(booking.appointment_date)} as {booking.appointment_time} ·{" "}
              ...
              <div className="grid gap-5 2xl:grid-cols-[minmax(0,0.92fr)_minmax(0,1.08fr)]">
                <div className="rounded-3xl border border-border/80 bg-card p-4 shadow-sm lg:p-5">
                  <div className="mb-4">
                    <h2 className="text-base font-semibold text-foreground">Acoes rapidas</h2>
                    <p className="text-xs text-muted-foreground">Rotinas mais usadas na operacao diaria.</p>
                  </div>
                  <div className="grid gap-3 sm:grid-cols-2 2xl:grid-cols-1">
                    <QuickAction
                      icon={UserPlus}
                      label="Novo paciente"
                      description="Abrir cadastro do prontuario"
                      to="/admin/pacientes"
                      compact
                    />
                    <QuickAction
                      ...
                      description="Importar ou revisar cardapios"
                      to="/admin/modelos"
                      compact
                    />
                    <QuickAction
                    ...
                    <QuickAction
                      icon={ReceiptText}
                      label="Pagamentos"
                      description="Ver pendencias e aprovacoes"
                      to="/admin/pagamentos"
                      compact
                    />
                  </div>
                ...
                <div className="rounded-3xl border border-border/80 bg-card p-4 shadow-sm lg:p-5">
                  <div className="mb-4 flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">Ultimos cadastros no sistema.</p>
                    </div>
            ...
            <div className="space-y-5">
              ...
              <div className="rounded-3xl border border-border/80 bg-card p-4 shadow-sm lg:p-5">
                <div className="mb-4">
                  <h2 className="text-base font-semibold text-foreground">Atalhos do painel</h2>
                  <p className="text-xs text-muted-foreground">Ajustes rapidos e secoes de apoio.</p>
                </div>
